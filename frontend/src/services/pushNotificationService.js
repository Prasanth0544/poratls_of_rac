...
// Handles push notification subscription for Admin portal
...
/**
 * Initialize push notifications for Admin portal
 */
export const initializePushNotifications = async (refreshCallback) => {
    console.log('🔔 Initializing Admin push notifications...');
