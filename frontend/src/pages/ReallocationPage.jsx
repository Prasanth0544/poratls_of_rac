...
const ReallocationPage = ({ trainData, loadTrainState, onClose }) => {
    ...
    const [activeTab, setActiveTab] = useState('global'); // 'global' or 'station-wise'
    const [stationWiseData, setStationWiseData] = useState(null); // Station-wise data

    // Fetch all data once on mount (no auto-refresh to prevent infinite loop)
    useEffect(() => {
        fetchData();
    ...
    const fetchStationWiseData = async () => {
        try {
            ...
            // Not critical, can continue without this data
        }
    };
        ...
        <div className="reallocation-page">
            ...
            <div className="page-header">
                ...
                <div className="tabs-container">
                    ...
                    <button
                        className={`tab ${activeTab === 'station-wise' ? 'active' : ''}`}
                        onClick={() => setActiveTab('station-wise')}
                    >
                        🚉 Station-Wise
                    </button>
                    <button
                        className={`tab ${activeTab === 'hashmap' ? 'active' : ''}`}
            ...
            {/* Tab Content */}
            {activeTab === 'global' && (
                /* Global Eligibility Matrix Section */
            ...
            {/* Current Station Matching Tab Content */}
            {activeTab === 'matching' && (
...
/**
 * Station-Wise View Component
 */
const StationWiseView = ({ stationWiseData, trainState, onRefresh }) => {
    if (!stationWiseData) {
        return (
            <div className="empty-state">
                <div className="empty-icon">⏳</div>
    ...
    return (
        <div className="station-wise-content">
            ...
            <div className="three-column-layout">
                {/* Column 1: Boarded RAC Passengers */}
                ...
                {/* Column 3: Pending Reallocations */}
                <div className="column">
...
/**
 * HashMap View Component - Dedicated tab for data structure visualization
 */
const HashMapView = ({ stationWiseData, trainState, onRefresh }) => {
    if (!stationWiseData) {
        return (
            <div className="empty-state">
                <div className="empty-icon">⏳</div>
...
/**
 * Current Station Matching View - Shows RAC and Vacant Berths HashMaps side-by-side
 */
const CurrentStationMatchingView = () => {
    ...
    const racPassengers = Array.from(Object.entries(racPassengersHashMap));
    const vacantBerths = Array.from(Object.entries(vacantBerthsHashMap));
