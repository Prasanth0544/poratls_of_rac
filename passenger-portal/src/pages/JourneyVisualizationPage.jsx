// passenger-portal/src/pages/JourneyVisualizationPage.jsx
...
function JourneyVisualizationPage() {
    ...
    const loadStationSchedule = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${API_URL}/visualization/station-schedule`);
